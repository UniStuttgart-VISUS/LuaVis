...
#if __BYTE_ORDER == __LITTLE_ENDIAN || _BYTE_ORDER == _LITTLE_ENDIAN || BYTE_ORDER == LITTLE_ENDIAN \
...
#if (defined(WOS_NET_LITTLE_ENDIAN) && defined(WOS_BIG_ENDIAN)) \
    || (defined(WOS_NET_BIG_ENDIAN) && defined(WOS_LITTLE_ENDIAN))
